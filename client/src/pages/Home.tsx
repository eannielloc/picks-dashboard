        ...
        <div>
          ...
          {today.length > 0 ? (
            ...
            <div className="glass p-10 text-center">
              <p className="text-xl font-semibold text-white/60 mb-6">Check out today's picks</p>
              <a href="https://t.me/blazepickss" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-[#229ED9] hover:bg-[#1a8bc2] text-white font-bold text-lg shadow-lg shadow-[#229ED9]/30 hover:shadow-[#229ED9]/50 transition-all duration-200 hover:scale-105">
